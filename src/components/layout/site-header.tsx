			...
			router.push("/admin/login");
					...
					return (
						<header className="sticky top-0 z-40 border-b border-slate-900/80 bg-slate-950/95 backdrop-blur-xl">
							...
							<Link href="/admin/packages" className="flex items-center gap-2">
								{/* eslint-disable-next-line @next/next/no-img-element */}
								<img
										src="/logo.png"
										alt="HimExplore logo"
										className="h-6 w-auto sm:h-6 transform origin-left scale-[5.4]"
									/>
							</Link>
				...
				return (
					<>
						<header className="sticky top-0 z-40 border-b border-slate-800/80 bg-slate-950/90 backdrop-blur-xl">
							<Container className="flex items-center justify-between py-3.5 sm:py-5 pl-3 pr-4 sm:px-4">
