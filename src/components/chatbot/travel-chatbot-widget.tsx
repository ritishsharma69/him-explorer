              ...
              <div>
                  ...
                  Ask for routes, budgets or hotel vibes.
			            ...
			            <button
			              type="button"
			              onClick={closeChat}
					      className="inline-flex items-center gap-1 rounded-full bg-slate-100 px-3 py-1.5 text-[10px] font-medium uppercase tracking-[0.18em] text-slate-500 hover:bg-slate-200"
			            >
